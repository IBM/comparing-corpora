...
from scipy.stats import chisquare, ttest_ind, mannwhitneyu
...
def ttest_distance(sentences1=None, sentences2=None,
                 embeddings1=None, embeddings2=None,
                 model: TextEmbedder = TransformerTextEmbedder()):
    # calculate mean and covariance statistics
    if embeddings1 is None and sentences1 is None:
        raise ValueError('Supply at least one of embeddings1, sentences1')
    if embeddings2 is None and sentences2 is None:
        raise ValueError('Supply at least one of embeddings2, sentences2')

    if embeddings1 is None:
        embeddings1 = model.embed_sentences(sentences1)
        embeddings2 = model.embed_sentences(sentences2)
...
def IRPR_distance(sentences1=None, sentences2=None,
                 embeddings1=None, embeddings2=None,
                 model: TextEmbedder = TransformerTextEmbedder()):
    # calculate mean and covariance statistics
    if embeddings1 is None and sentences1 is None:
...
def classifier_distance(embeddings1, embeddings2):
...
def medoid_distance(sentences1=None, sentences2=None,
                 embeddings1=None, embeddings2=None,
                 model: TextEmbedder = TransformerTextEmbedder()):
    # calculate mean and covariance statistics
    if embeddings1 is None and sentences1 is None:
...
def fid_distance(sentences1=None, sentences2=None,
                 embeddings1=None, embeddings2=None,
                 model: TextEmbedder = TransformerTextEmbedder()):
    # calculate mean and covariance statistics
    if embeddings1 is None and sentences1 is None:
...
def mauve_distance(sentences1=None, sentences2=None,
                 embeddings1=None, embeddings2=None,
                 model: TextEmbedder = TransformerTextEmbedder()):
    if embeddings1 is None and sentences1 is None:
        raise ValueError('Supply at least one of embeddings1, sentences1')
...
def pr_distance(sentences1=None, sentences2=None,
                embeddings1=None, embeddings2=None,
                model: TextEmbedder = TransformerTextEmbedder(), nearest_k=5):
...
def chi_square_distance(tokens1=None, tokens2=None,
                  sentences1=None, sentences2=None,
                  tokenizer:TextEmbedder=TransformerTextEmbedder(), top=5000):
    """
    Given two sets of words calculates pearson chi square statistic.
    """

    if tokens1 is None and sentences1 is None:
        raise ValueError('Supply at least one of sentences1 or tokens1')
    if tokens2 is None and sentences2 is None:
        raise ValueError('Supply at least one of sentences2 or tokens2')

    if tokens2 is None:
        tokens1 = tokenizer.tokenize_sentences(sentences1)
        tokens2 = tokenizer.tokenize_sentences(sentences2)
...
def dc_distance(sentences1=None, sentences2=None,
                embeddings1=None, embeddings2=None,
                model: TextEmbedder = TransformerTextEmbedder(), nearest_k=5):
...
def zipf_distance(sentences1=None, sentences2=None,
                  tokens1=None, tokens2=None,
                  tokenizer: TextEmbedder=TransformerTextEmbedder()):
